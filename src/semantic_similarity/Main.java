...
import semantic_similarity.techniques.monolingual_mapping.MUSE;
...
public class Main {
    public static void main(String[] args) {
        ...
        UnifiedVectorSpace multilingual = util.loadSpace(Settings.EMBEDDING_PATH + "muse_multilingual.txt", ELanguage.MULTILINGUAL, Integer.MAX_VALUE);
