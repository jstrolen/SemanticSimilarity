...
**RTR+BSwWA 5\*300M+** |
context=5;nGram=3-6||0,656 *0,654* (0,693) |0,635 *0,628* (0,680) |0,604 *0,583* (0,636) ||0,589 *0,593* (0,632) |0,650 *0,651* (0,691) |0,629 *0,635* (0,656) ||0,627 *0,624* (0,665) 
context=5;nGram=2-8||0,638 *0,630* (0,674) |0,613 *0,603* (0,658) |0,574 *0,547* (0,607) ||0,566 *0,567* (0,609) |0,631 *0,631* (0,676) |0,607 *0,610* (0,633) ||0,605 *0,598* (0,643)
context=8;nGram=3-6||0,647 *0,645* (0,677) |0,621 *0,611* (0,661) |0,603 *0,576* (0,631) ||0,577 *0,582* (0,618) |0,634 *0,633* (0,670) |0,618 *0,624* (0,641) ||0,617 *0,612* (0,650) 
context=8;nGram=2-8||0,630 *0,623* (0,661) |0,606 *0,588* (0,645) |0,574 *0,540* (0,604) ||0,547 *0,548* (0,589) |0,614 *0,613* (0,655) |0,594 *0,599* (0,618) ||0,594 *0,585* (0,629)  
**PCA**|
PCA||0,656 *0,503* (0,724) |0,674 *0,576* (0,726) |0,617 *0,616* (0,701) ||0,597 *0,525* (0,663) |0,639 *0,507* (0,702) |0,598 *0,519* (0,690) ||0,630 *0,541* (0,701) 
